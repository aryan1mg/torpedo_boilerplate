...
class UserManagerTest(asynctest.TestCase):
    ...
    async def test_get_users_raises_exception_with_no_results(self, orm_mock, cache_mock):
    ...
    async def test_get_users_with_results_return_success(self, orm_mock, cache_mock, cache_set_mock):
